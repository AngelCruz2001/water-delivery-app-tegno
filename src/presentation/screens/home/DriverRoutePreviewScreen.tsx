    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
                ...
                <MapView
                    ...
                    showsUserLocation
                >
                    <MapDirections origin={location} mapViewRef={mapViewRef} destination={location} waypoints={filteredWaypoints} setWaypointsInfo={() => { }} />
                ...
                <Card style={{ height: height - mapHeight, gap: 10 }}>
                    ...
                    <Pressable
                        ...
                        onPress={() => routeOnView && navigation.navigate('DriverRouteMap', { waypoints: filteredWaypoints, route: routeOnView, numberAlreadyDelivered: waypointsInfo.length - filteredWaypoints.length })}
                    >
